...
if __name__ == '__main__':
    ...
    if args.metric == 'all' or args.metric == 'tsne':
        txt_path = '/vol/biomedic3/mq21/data/cardiac/UKbiobank/label/mesh_40616/mesh_train.csv'
        ...
        resultpath_tsne = '/vol/biomedic3/mq21/code/Results_CHeart/visual_jupyter/latentspace_ukbb'
        setup_dir(resultpath_tsne)
        fh = open(txt_path, 'r')
        report_data_dict = latent_space_visual_ukbb(resultpath_tsne, args=args, model=model, device=device, test_dataloader=train_dataloader)
